...
lse_test_targets=(test_kernel_env test_ir test_dtype test_shape test_quant test_backend_cpu test_primitive test_trace
  ...
  test_scheduler_epilogue test_loom_matrix test_loom_dot)
