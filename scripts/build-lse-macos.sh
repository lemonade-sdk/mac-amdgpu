...
lse_test_targets=(test_kernel_env test_ir test_dtype test_shape test_quant test_graph test_backend_cpu test_primitive test_trace
  ...
  test_scheduler_epilogue test_inplace_owner test_loom_matrix test_loom_dot test_fp8_conversion test_quant_operand_policy test_cooperative_rms)
